...
public class LevelGeneratorHard : MonoBehaviour
{
    private static LevelGeneratorHard instance;
    ...
    public static int GetLevelPartSpawnedHard()
    {
